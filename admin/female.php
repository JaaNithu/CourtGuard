        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Female Offenders Details</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="example" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php
                                        $cr_details_query = "SELECT * FROM cr_details WHERE gender = 'Female' ";
                                        ...
                                        if(mysqli_num_rows($cr_details_query_run) > 0){
                                            foreach($cr_details_query_run as $row){
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="female_view_details.php?nic=<?php echo $row['nic']; ?>" class="btn btn-info viewBtn">View</a>
                                                    </td>
                                                </tr>
                                                <?php
                                            }
