...
<!-- <div class="py-3 bg-secondary">
    <div class="container">
        <h4 class="text-white text-center mb-0"> Details</h4>
    </div>
</div> -->
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                ...
                                <a href="user_recent_offense.php" class="btn btn-danger">Back</a>
                            </div>
                                            ...
                                            if(mysqli_num_rows($cr_details_query_run) > 0)
                                            {
                                                foreach($cr_details_query_run as $row)
                                                {
                                                    ...
                                                    ?>
                                                        ...
                                                        <tr>
                                                            <th>Photo</th>
                                                            <td><img src="admin/uploads/offenders/<?php echo $row['photo'];?>" width="150px" height="150px"/></td>
                                                        </tr>
                                                        <tr>
                                                            <th>Register No</th>
